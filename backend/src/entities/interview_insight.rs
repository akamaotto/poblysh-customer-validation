...
pub struct Model {
    ...
    pub biggest_pains: Option<Json>,
    pub desired_outcomes: Option<Json>,
    pub jtbd_functional: Option<String>,
    pub jtbd_social: Option<String>,
    pub jtbd_emotional: Option<String>,
    pub excited_features: Option<Json>,
    pub ignored_features: Option<Json>,
    pub main_objections: Option<Json>,
